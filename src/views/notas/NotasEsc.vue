<template>
    <div>
        <h1 style="margin-top:-10vh;">Escrever nota</h1>
        <link rel="stylesheet"
            ...
            <div class="row">
                <div class="col-sm-11">
                    <div class="form">
                        ...
                        <button class="btn btn-primary esq" @click="addNote" title="Salvar">
                            <div class="material-symbols-outlined" style="font-size: 2em;padding: 1%;">
                                save
                            </div>
                        </button>
                        <button class="btn btn-primary dir" title="Ler as notas" onclick="window.location.href='/notas/escrever#ler'">
                            <div class="material-symbols-outlined" style="font-size: 2em;padding: 1%;">
                                rate_review
                            </div>
                        </button>
                        <div class="alert alert-danger text-center" role="alert" v-bind:class="{ active: isActive }">
        ...
        <div class="menu2" id="ler">
            <h1>Leia suas anotações</h1>
            <h3 style="margin-top:-3vh">Total de notas: {{ notes.length }}</h3>
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 note" v-for:="(note, index) in notes">
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted" style="color:black">{{ note.date }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <button title="Voltar para a escrita" id="subida" onclick="window.location.href='/notas/escrever'">
                <div class="material-symbols-outlined final" style="font-size: 2em;padding: 1%;">
                    undo
                </div>
            </button>
        </div>
