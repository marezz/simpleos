<template>
    <div>
        <h1 style="margin-top:-10vh;">Bloco de Notas</h1>
        ...
        <div class="menu">
            <p id="marginLeft">&#8205;</p>
            <span>
                <router-link to='/notas/escrever' class="link"><img style="margin-left:-5vh"
                        src="@/assets/notas/escrever.png" /><br />Anotar
                </router-link>
            </span>
            <span>
                <router-link :to="{ path: '/notas/desenhar' }" class="link"><img
                        src="@/assets/notas/paint.png" /><br />Desenhar
                </router-link>
            </span>
            <p id="marginRight">&#8205;</p>
        </div>
